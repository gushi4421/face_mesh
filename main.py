...
def main(args):
    ...
    face_mesh_detector = FaceMeshDetector(
        model_path=args.model_path, maxFaces=args.maxfaces
    )
    ...
    while capture.isOpened():
        ...
        processed_frame, skeleton_img, landmarks = face_mesh_detector.find_face_mesh(
        ...
        dst = face_mesh_detector.img_combine(processed_frame, skeleton_img)
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        "--print_landmarks",
        type=bool,
        default=config.get("print_landmarks"),
        help="是否打印人脸关键点",
    )
    argparser.add_argument(
        "--model_path",
